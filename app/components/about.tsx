...
import { GraduationCap, BrainCircuit, Laptop2, Compass, Sparkles  } from "lucide-react"
import {
  FaHtml5, 
  FaCss3Alt, 
  FaJs, 
...
const skillCategories = [
  ...
  },
  {
    ...
    skills: [
      { name: 'Python', icon: <SiPython size={20} className="text-blue-400" />, desc: 'Automation & ML' },
      { name: 'Supabase', icon: <SiSupabase size={20} className="text-green-600" />, desc: 'Backend-as-a-Service' },
      { name: 'Node js', icon: <SiNodedotjs size={20} className="text-green-400" />, desc: 'JavaScript Runtime Environment' },
  ...
  },
  {
    ...
    skills: [
      ...
      { name: 'Vscode', icon: <VscVscodeInsiders        size={20} className="text-blue-600" />, desc: 'Powerful Code Editor' },
              { name: 'Collab', icon: <Image src="/colab.png" width={20} height={20} alt="Collab" className="text-blue-600" />, desc: 'Online code editor' },
      
      { name: 'github', icon: <SiGithub size={20} className="text-white" />, desc: ' Code Collaboration Platform' },
    ]
  },
  {
    name: "AI Integration",
...
const SkillCard = ({ name, icon, desc }: SkillProps) => (
...
const ProfileCard = () => {
  ...
  // const [ setIsNavVisible] = useState(false);
          ...
          <div className="flex flex-col md:flex-row md:items-center gap-12">
            ...
            <div className="md:w-1/2 flex justify-center">
              <div className="relative">
                ...
                <div className="relative h-64 w-64 border-4 border-neutral-800 rounded-full overflow-hidden">
                  <Image
                    src="/minam.png"
                    fill
                    className="object-cover"
                    alt="Syed Minam's profile picture"
                  />
                </div>
              </div>
            </div>
...
<div className="bg-gradient-to-br from-white/5 to-white/10 border border-white/10 rounded-2xl p-6 shadow-lg backdrop-blur-sm transition-all duration-300">
  ...
  <div className="space-y-6 text-neutral-300">
    ...
    <div className="flex items-start gap-4">
      <BrainCircuit className="text-white w-8 h-8 mt-1" />
      <div>
        <h4 className="text-lg font-semibold text-white">
...
<div className="bg-gradient-to-br from-white/5 to-white/10 border border-white/10 rounded-2xl p-6 shadow-lg backdrop-blur-sm transition-all duration-300">
  ...
  <p className="text-neutral-300 text-sm leading-relaxed">
    ...
    on crafting intuitive user experiences that are both accessible and visually refined.
      ...
      {/* <section id="projects" className="py-20 px-6 bg-neutral-900/50">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
              ...
              >
                <div className="h-48 bg-neutral-800 relative">
                  <div className="absolute inset-0 flex items-center justify-center">
                    <span className="text-neutral-500 font-medium">Project Image</span>
                  </div>
                </div>
                <div className="p-6">
                  ...
                  <div className="flex gap-2">
                    {["Next.js", "TypeScript", "Tailwind"].map((tech) => (
                      <span key={tech} className="text-xs px-2 py-1 bg-white/5 rounded-md">
                        {tech}
                      </span>
                    ))}
                  </div>
          ...
          <div className="flex flex-col md:flex-row gap-16">
            <div className="md:w-1/2">
              ...
              <div className="space-y-6">
                {[
                  { icon: <FaLinkedinIn size={20} />, name: "LinkedIn", username: "Syed Minam", link: "https://www.linkedin.com/in/syed-minam-ur-rehman/" },
        ...
        <div className="max-w-6xl mx-auto">
          <div className="flex flex-col md:flex-row justify-between items-center gap-6">
            ...
            <div className="flex items-center gap-6">
              <Link href="https://www.linkedin.com/in/syed-minam-ur-rehman/" target="_blank" rel="noopener noreferrer">
                <FaLinkedinIn className="text-neutral-400 hover:text-white transition-colors" />
              </Link>
              <Link href="https://github.com/minamrahman727" target="_blank" rel="noopener noreferrer">
                <FaGithub className="text-neutral-400 hover:text-white transition-colors" />
              </Link>
              <Link href="https://www.instagram.com/syedminamurrehman" target="_blank" rel="noopener noreferrer">
                <FaInstagram className="text-neutral-400 hover:text-white transition-colors" />
              </Link>
            </div>
